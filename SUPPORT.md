...
still belongs in an issue or a discussion afterwards, because Slack history is
not searchable from outside and does not last.

Before asking, run `glyf doctor` in your project and include its output. It
