...
from dbt_charts.dashboard.components import ComponentError, ComponentSpec
from dbt_charts.dashboard.loader import Dashboard, DashboardItem, DashboardSection
from dbt_charts.dashboard.macros import alert, time, ui
...
def _load_module(macros_path: Path) -> ModuleType:
    module_name = "dbt_charts_project_macros_" + hashlib.sha1(
